...
import com.dev.android.lastf.model.Gender;
...
public class AlbumViewModel extends Observable {
    ...
    public void getTopAlbums() {
        ...
        String url = LastConstants.BASE_URL + LastConstants.TOP_ALBUMS + selectedGender +LastConstants.API_KEY + LastConstants.JSON_FRM;
